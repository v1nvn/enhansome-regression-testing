# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,326 | 🐛 60 | 📅 2026-04-02 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,184 | 🐛 200 | 🌐 Java | 📅 2026-04-06 - Browser automation framework and ecosystem.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,021 | 🐛 304 | 🌐 TypeScript | 📅 2026-04-05 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,660 | 🐛 608 | 🌐 TypeScript | 📅 2026-04-03 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,946 | 🐛 337 | 🌐 JavaScript | 📅 2026-04-05 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,916 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-02 - Automated browser testing for the modern web development stack.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,219 | 🐛 211 | 🌐 JavaScript | 📅 2026-04-05 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,908 | 🐛 32 | 🌐 Java | 📅 2026-04-05 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,184 | 🐛 200 | 🌐 Java | 📅 2026-04-06.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,021 | 🐛 304 | 🌐 TypeScript | 📅 2026-04-05.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,021 | 🐛 304 | 🌐 TypeScript | 📅 2026-04-05.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,184 | 🐛 200 | 🌐 Java | 📅 2026-04-06.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 679 | 🐛 59 | 🌐 Shell | 📅 2026-04-02 - Open Source selfhosted service for visual regression testing
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,184 | 🐛 200 | 🌐 Java | 📅 2026-04-06.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,184 | 🐛 200 | 🌐 Java | 📅 2026-04-06 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,764 | 🐛 282 | 🌐 TypeScript | 📅 2026-04-04 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,184 | 🐛 200 | 🌐 Java | 📅 2026-04-06.
