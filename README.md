# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 458,701 | 🐛 68 | 📅 2026-04-19 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,060 | 🐛 190 | 🌐 Java | 📅 2026-04-25 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,802 | 🐛 297 | 🌐 TypeScript | 📅 2026-04-24 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,188 | 🐛 306 | 🌐 TypeScript | 📅 2026-04-24 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 87,250 | 🐛 622 | 🌐 TypeScript | 📅 2026-04-25 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,945 | 🐛 336 | 🌐 JavaScript | 📅 2026-04-05 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,913 | 🐛 40 | 🌐 JavaScript | 📅 2026-04-15 - Automated browser testing for the modern web development stack.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,220 | 🐛 207 | 🌐 JavaScript | 📅 2026-04-23 - Modern Era Acceptance Testing Framework for NodeJS.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,907 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-23 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,908 | 🐛 28 | 🌐 Java | 📅 2026-04-24 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,416 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,060 | 🐛 190 | 🌐 Java | 📅 2026-04-25.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,262 | 🐛 68 | 🌐 TypeScript | 📅 2026-04-23 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,188 | 🐛 306 | 🌐 TypeScript | 📅 2026-04-24.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 404 | 🐛 42 | 🌐 JavaScript | 📅 2026-04-23 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,188 | 🐛 306 | 🌐 TypeScript | 📅 2026-04-24.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,060 | 🐛 190 | 🌐 Java | 📅 2026-04-25.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 682 | 🐛 59 | 🌐 Shell | 📅 2026-04-02 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 47 | 🌐 JavaScript | 📅 2026-04-23 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,060 | 🐛 190 | 🌐 Java | 📅 2026-04-25.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,060 | 🐛 190 | 🌐 Java | 📅 2026-04-25 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
* [dpxdt](https://github.com/bslatkin/dpxdt) ⭐ 1,442 | 🐛 29 | 🌐 Python | 📅 2016-12-05 - End-to-end testing with Python.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,802 | 🐛 297 | 🌐 TypeScript | 📅 2026-04-24 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,060 | 🐛 190 | 🌐 Java | 📅 2026-04-25.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,379 | 🐛 13 | 📅 2026-03-01.
