# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,997 | 🐛 61 | 📅 2026-04-02 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,189 | 🐛 199 | 🌐 Java | 📅 2026-04-08 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,768 | 🐛 285 | 🌐 TypeScript | 📅 2026-04-06 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,042 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-07 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,796 | 🐛 612 | 🌐 TypeScript | 📅 2026-04-07 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,219 | 🐛 209 | 🌐 JavaScript | 📅 2026-04-08 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,907 | 🐛 33 | 🌐 Java | 📅 2026-04-07 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,416 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,189 | 🐛 199 | 🌐 Java | 📅 2026-04-08.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,042 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-07.
...
* [Happo](https://github.com/happo/happo.io) ⭐ 206 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-07 - Visual diffing in CI for user interfaces.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,042 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-07.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,189 | 🐛 199 | 🌐 Java | 📅 2026-04-08.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,189 | 🐛 199 | 🌐 Java | 📅 2026-04-08.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,189 | 🐛 199 | 🌐 Java | 📅 2026-04-08 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,768 | 🐛 285 | 🌐 TypeScript | 📅 2026-04-06 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,189 | 🐛 199 | 🌐 Java | 📅 2026-04-08.
