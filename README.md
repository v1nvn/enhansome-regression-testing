# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 457,324 | 🐛 65 | 📅 2026-04-19 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,245 | 🐛 1 | 📅 2026-04-17.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,074 | 🐛 192 | 🌐 Java | 📅 2026-04-21 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,792 | 🐛 287 | 🌐 TypeScript | 📅 2026-04-20 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,165 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-20 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 86,912 | 🐛 634 | 🌐 TypeScript | 📅 2026-04-21 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,943 | 🐛 336 | 🌐 JavaScript | 📅 2026-04-05 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,221 | 🐛 210 | 🌐 JavaScript | 📅 2026-04-20 - Modern Era Acceptance Testing Framework for NodeJS.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,906 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-10 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,907 | 🐛 28 | 🌐 Java | 📅 2026-04-20 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Lost Pixel](https://github.com/lost-pixel/lost-pixel) ⭐ 1,659 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-19 - Holistic visual regression testing for full pages, components (via Storybook and Ladle integration), and custom shots (e.g. via Cypress).
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,074 | 🐛 192 | 🌐 Java | 📅 2026-04-21.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,165 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-20.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 402 | 🐛 41 | 🌐 JavaScript | 📅 2026-04-20 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,165 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-20.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,074 | 🐛 192 | 🌐 Java | 📅 2026-04-21.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,074 | 🐛 192 | 🌐 Java | 📅 2026-04-21.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,074 | 🐛 192 | 🌐 Java | 📅 2026-04-21 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,792 | 🐛 287 | 🌐 TypeScript | 📅 2026-04-20 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,074 | 🐛 192 | 🌐 Java | 📅 2026-04-21.
