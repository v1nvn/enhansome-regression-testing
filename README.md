# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,155 | 🐛 70 | 📅 2026-01-28 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,202 | 🐛 2 | 📅 2026-02-17.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,031 | 🐛 215 | 🌐 Java | 📅 2026-02-18 - Browser automation framework and ecosystem.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,595 | 🐛 287 | 🌐 TypeScript | 📅 2026-02-17 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,747 | 🐛 601 | 🌐 TypeScript | 📅 2026-02-17 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 20,004 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,218 | 🐛 215 | 🌐 JavaScript | 📅 2026-02-17 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Lost Pixel](https://github.com/lost-pixel/lost-pixel) ⭐ 1,632 | 🐛 66 | 🌐 TypeScript | 📅 2026-02-12 - Holistic visual regression testing for full pages, components (via Storybook and Ladle integration), and custom shots (e.g. via Cypress).
* [Galen](https://github.com/galenframework/galen) ⭐ 1,416 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,031 | 🐛 215 | 🌐 Java | 📅 2026-02-18.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,595 | 🐛 287 | 🌐 TypeScript | 📅 2026-02-17.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 399 | 🐛 41 | 🌐 JavaScript | 📅 2026-02-17 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,595 | 🐛 287 | 🌐 TypeScript | 📅 2026-02-17.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,031 | 🐛 215 | 🌐 Java | 📅 2026-02-18.
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-18 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,031 | 🐛 215 | 🌐 Java | 📅 2026-02-18.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,031 | 🐛 215 | 🌐 Java | 📅 2026-02-18 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,721 | 🐛 272 | 🌐 TypeScript | 📅 2026-02-18 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,031 | 🐛 215 | 🌐 Java | 📅 2026-02-18.
