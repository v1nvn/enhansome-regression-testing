# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,652 | 🐛 67 | 📅 2026-01-28 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,199 | 🐛 4 | 📅 2026-01-21.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 33,983 | 🐛 214 | 🌐 Java | 📅 2026-02-07 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,718 | 🐛 268 | 🌐 TypeScript | 📅 2026-02-06 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,511 | 🐛 283 | 🌐 TypeScript | 📅 2026-02-06 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,261 | 🐛 595 | 🌐 TypeScript | 📅 2026-02-07 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 20,000 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,949 | 🐛 338 | 🌐 JavaScript | 📅 2026-01-21 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,217 | 🐛 211 | 🌐 JavaScript | 📅 2026-02-06 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Loki](https://github.com/oblador/loki) ⭐ 1,891 | 🐛 140 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
* [Lost Pixel](https://github.com/lost-pixel/lost-pixel) ⭐ 1,628 | 🐛 66 | 🌐 TypeScript | 📅 2026-02-06 - Holistic visual regression testing for full pages, components (via Storybook and Ladle integration), and custom shots (e.g. via Cypress).
* [Galen](https://github.com/galenframework/galen) ⭐ 1,414 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 33,983 | 🐛 214 | 🌐 Java | 📅 2026-02-07.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,246 | 🐛 66 | 🌐 TypeScript | 📅 2026-02-02 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,511 | 🐛 283 | 🌐 TypeScript | 📅 2026-02-06.
...
* [Creevey](https://github.com/wKich/creevey) ⭐ 425 | 🐛 42 | 🌐 TypeScript | 📅 2025-12-02 - Cross-browser visual testing with magic. Feature-rich tool with UI Runner, Tests Hot Reloading, Docker and Storybook integration.
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 398 | 🐛 41 | 🌐 JavaScript | 📅 2026-02-06 - Visual regression test tool which output easy-to-read single file html report.
...
* [Happo](https://github.com/happo/happo.io) ⭐ 207 | 🐛 26 | 🌐 JavaScript | 📅 2026-01-21 - Visual diffing in CI for user interfaces.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,511 | 🐛 283 | 🌐 TypeScript | 📅 2026-02-06.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 33,983 | 🐛 214 | 🌐 Java | 📅 2026-02-07.
* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 674 | 🐛 57 | 🌐 Shell | 📅 2026-01-09 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 27 | 🌐 JavaScript | 📅 2026-02-06 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 33,983 | 🐛 214 | 🌐 Java | 📅 2026-02-07.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 33,983 | 🐛 214 | 🌐 Java | 📅 2026-02-07 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,718 | 🐛 268 | 🌐 TypeScript | 📅 2026-02-06 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 33,983 | 🐛 214 | 🌐 Java | 📅 2026-02-07.
