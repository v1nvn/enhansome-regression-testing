# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,833 | 🐛 67 | 📅 2026-01-28 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,001 | 🐛 212 | 🌐 Java | 📅 2026-02-12 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,718 | 🐛 268 | 🌐 TypeScript | 📅 2026-02-10 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,553 | 🐛 286 | 🌐 TypeScript | 📅 2026-02-11 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,489 | 🐛 583 | 🌐 TypeScript | 📅 2026-02-12 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,219 | 🐛 208 | 🌐 JavaScript | 📅 2026-02-11 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,001 | 🐛 212 | 🌐 Java | 📅 2026-02-12.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,553 | 🐛 286 | 🌐 TypeScript | 📅 2026-02-11.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 399 | 🐛 41 | 🌐 JavaScript | 📅 2026-02-11 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,553 | 🐛 286 | 🌐 TypeScript | 📅 2026-02-11.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,001 | 🐛 212 | 🌐 Java | 📅 2026-02-12.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,001 | 🐛 212 | 🌐 Java | 📅 2026-02-12.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,001 | 🐛 212 | 🌐 Java | 📅 2026-02-12 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,718 | 🐛 268 | 🌐 TypeScript | 📅 2026-02-10 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,001 | 🐛 212 | 🌐 Java | 📅 2026-02-12.
