# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,029 | 🐛 68 | 📅 2026-04-19 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,062 | 🐛 195 | 🌐 Java | 📅 2026-04-26 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,802 | 🐛 298 | 🌐 TypeScript | 📅 2026-04-24 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,192 | 🐛 310 | 🌐 TypeScript | 📅 2026-04-26 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 87,321 | 🐛 628 | 🌐 TypeScript | 📅 2026-04-25 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,909 | 🐛 28 | 🌐 Java | 📅 2026-04-24 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
* [Loki](https://github.com/oblador/loki) ⭐ 1,901 | 🐛 140 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,417 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,062 | 🐛 195 | 🌐 Java | 📅 2026-04-26.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,192 | 🐛 310 | 🌐 TypeScript | 📅 2026-04-26.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,192 | 🐛 310 | 🌐 TypeScript | 📅 2026-04-26.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,062 | 🐛 195 | 🌐 Java | 📅 2026-04-26.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,062 | 🐛 195 | 🌐 Java | 📅 2026-04-26.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,062 | 🐛 195 | 🌐 Java | 📅 2026-04-26 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,802 | 🐛 298 | 🌐 TypeScript | 📅 2026-04-24 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,062 | 🐛 195 | 🌐 Java | 📅 2026-04-26.
