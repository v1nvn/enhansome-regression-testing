# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,676 | 🐛 68 | 📅 2026-04-19 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,253 | 🐛 1 | 📅 2026-04-22.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,068 | 🐛 191 | 🌐 Java | 📅 2026-04-28 - Browser automation framework and ecosystem.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,209 | 🐛 304 | 🌐 TypeScript | 📅 2026-04-27 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 87,477 | 🐛 624 | 🌐 TypeScript | 📅 2026-04-28 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,135 | 🐛 574 | 🌐 JavaScript | 📅 2024-09-07 - Config-driven automated screenshot test framework.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,221 | 🐛 209 | 🌐 JavaScript | 📅 2026-04-28 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,910 | 🐛 28 | 🌐 Java | 📅 2026-04-27 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,418 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,068 | 🐛 191 | 🌐 Java | 📅 2026-04-28.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 637 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,209 | 🐛 304 | 🌐 TypeScript | 📅 2026-04-27.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 405 | 🐛 42 | 🌐 JavaScript | 📅 2026-04-23 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,209 | 🐛 304 | 🌐 TypeScript | 📅 2026-04-27.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,068 | 🐛 191 | 🌐 Java | 📅 2026-04-28.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,068 | 🐛 191 | 🌐 Java | 📅 2026-04-28.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,068 | 🐛 191 | 🌐 Java | 📅 2026-04-28 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,804 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-27 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,068 | 🐛 191 | 🌐 Java | 📅 2026-04-28.
