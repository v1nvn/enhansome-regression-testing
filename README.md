# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,984 | 🐛 59 | 📅 2026-04-02 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,071 | 🐛 200 | 🌐 Java | 📅 2026-04-11 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,773 | 🐛 282 | 🌐 TypeScript | 📅 2026-04-09 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,078 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-10 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 86,047 | 🐛 614 | 🌐 TypeScript | 📅 2026-04-11 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,842 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,217 | 🐛 213 | 🌐 JavaScript | 📅 2026-04-10 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Lost Pixel](https://github.com/lost-pixel/lost-pixel) ⭐ 1,654 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-08 - Holistic visual regression testing for full pages, components (via Storybook and Ladle integration), and custom shots (e.g. via Cypress).
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,071 | 🐛 200 | 🌐 Java | 📅 2026-04-11.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,078 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-10.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,078 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-10.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,071 | 🐛 200 | 🌐 Java | 📅 2026-04-11.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,071 | 🐛 200 | 🌐 Java | 📅 2026-04-11.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,071 | 🐛 200 | 🌐 Java | 📅 2026-04-11 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,773 | 🐛 282 | 🌐 TypeScript | 📅 2026-04-09 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,071 | 🐛 200 | 🌐 Java | 📅 2026-04-11.
