# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,364 | 🐛 59 | 📅 2026-04-02 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,191 | 🐛 203 | 🌐 Java | 📅 2026-04-09 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,767 | 🐛 283 | 🌐 TypeScript | 📅 2026-04-08 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,048 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-08 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,862 | 🐛 606 | 🌐 TypeScript | 📅 2026-04-09 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,935 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
...
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,916 | 🐛 36 | 🌐 JavaScript | 📅 2026-04-02 - Automated browser testing for the modern web development stack.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,906 | 🐛 33 | 🌐 Java | 📅 2026-04-08 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,416 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,191 | 🐛 203 | 🌐 Java | 📅 2026-04-09.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,259 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-08 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,048 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-08.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 401 | 🐛 41 | 🌐 JavaScript | 📅 2026-04-08 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,048 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-08.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,191 | 🐛 203 | 🌐 Java | 📅 2026-04-09.
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 44 | 🌐 JavaScript | 📅 2026-04-09 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,191 | 🐛 203 | 🌐 Java | 📅 2026-04-09.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,191 | 🐛 203 | 🌐 Java | 📅 2026-04-09 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,767 | 🐛 283 | 🌐 TypeScript | 📅 2026-04-08 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,191 | 🐛 203 | 🌐 Java | 📅 2026-04-09.
