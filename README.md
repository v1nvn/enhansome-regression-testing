# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 448,615 | 🐛 88 | 📅 2026-03-09 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,172 | 🐛 193 | 🌐 Java | 📅 2026-03-25 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,751 | 🐛 280 | 🌐 TypeScript | 📅 2026-03-23 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,933 | 🐛 296 | 🌐 TypeScript | 📅 2026-03-24 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 84,934 | 🐛 624 | 🌐 TypeScript | 📅 2026-03-25 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,221 | 🐛 208 | 🌐 JavaScript | 📅 2026-03-24 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,910 | 🐛 31 | 🌐 Java | 📅 2026-03-24 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Lost Pixel](https://github.com/lost-pixel/lost-pixel) ⭐ 1,650 | 🐛 66 | 🌐 TypeScript | 📅 2026-03-19 - Holistic visual regression testing for full pages, components (via Storybook and Ladle integration), and custom shots (e.g. via Cypress).
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,172 | 🐛 193 | 🌐 Java | 📅 2026-03-25.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,933 | 🐛 296 | 🌐 TypeScript | 📅 2026-03-24.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,933 | 🐛 296 | 🌐 TypeScript | 📅 2026-03-24.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,172 | 🐛 193 | 🌐 Java | 📅 2026-03-25.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,172 | 🐛 193 | 🌐 Java | 📅 2026-03-25.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,172 | 🐛 193 | 🌐 Java | 📅 2026-03-25 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,751 | 🐛 280 | 🌐 TypeScript | 📅 2026-03-23 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,172 | 🐛 193 | 🌐 Java | 📅 2026-03-25.
