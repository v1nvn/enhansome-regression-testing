# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,721 | 🐛 71 | 📅 2026-01-28 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,201 | 🐛 2 | 📅 2026-02-15.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,014 | 🐛 213 | 🌐 Java | 📅 2026-02-16 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,721 | 🐛 271 | 🌐 TypeScript | 📅 2026-02-13 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,578 | 🐛 289 | 🌐 TypeScript | 📅 2026-02-15 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,667 | 🐛 595 | 🌐 TypeScript | 📅 2026-02-14 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,218 | 🐛 212 | 🌐 JavaScript | 📅 2026-02-15 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,014 | 🐛 213 | 🌐 Java | 📅 2026-02-16.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,578 | 🐛 289 | 🌐 TypeScript | 📅 2026-02-15.
...
* [Happo](https://github.com/happo/happo.io) ⭐ 206 | 🐛 26 | 🌐 JavaScript | 📅 2026-02-14 - Visual diffing in CI for user interfaces.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,578 | 🐛 289 | 🌐 TypeScript | 📅 2026-02-15.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,014 | 🐛 213 | 🌐 Java | 📅 2026-02-16.
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 28 | 🌐 JavaScript | 📅 2026-02-15 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,014 | 🐛 213 | 🌐 Java | 📅 2026-02-16.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,014 | 🐛 213 | 🌐 Java | 📅 2026-02-16 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,721 | 🐛 271 | 🌐 TypeScript | 📅 2026-02-13 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,014 | 🐛 213 | 🌐 Java | 📅 2026-02-16.
