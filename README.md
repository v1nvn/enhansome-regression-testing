# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 455,372 | 🐛 62 | 📅 2026-04-02 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,239 | 🐛 2 | 📅 2026-04-08.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,079 | 🐛 191 | 🌐 Java | 📅 2026-04-15 - Browser automation framework and ecosystem.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,117 | 🐛 299 | 🌐 TypeScript | 📅 2026-04-14 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 86,469 | 🐛 624 | 🌐 TypeScript | 📅 2026-04-15 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,942 | 🐛 337 | 🌐 JavaScript | 📅 2026-04-05 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,913 | 🐛 38 | 🌐 JavaScript | 📅 2026-04-12 - Automated browser testing for the modern web development stack.
* [Protractor](https://github.com/angular/protractor) ⚠️ Archived - E2E test framework for Angular apps.
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,124 | 🐛 574 | 🌐 JavaScript | 📅 2024-09-07 - Config-driven automated screenshot test framework.
...
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,908 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-10 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,907 | 🐛 28 | 🌐 Java | 📅 2026-04-14 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,079 | 🐛 191 | 🌐 Java | 📅 2026-04-15.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,117 | 🐛 299 | 🌐 TypeScript | 📅 2026-04-14.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,117 | 🐛 299 | 🌐 TypeScript | 📅 2026-04-14.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,079 | 🐛 191 | 🌐 Java | 📅 2026-04-15.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,079 | 🐛 191 | 🌐 Java | 📅 2026-04-15.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,079 | 🐛 191 | 🌐 Java | 📅 2026-04-15 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,783 | 🐛 282 | 🌐 TypeScript | 📅 2026-04-14 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,079 | 🐛 191 | 🌐 Java | 📅 2026-04-15.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,376 | 🐛 11 | 📅 2026-03-01.
