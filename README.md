# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,443 | 🐛 88 | 📅 2026-03-09 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,229 | 🐛 2 | 📅 2026-03-24.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,188 | 🐛 199 | 🌐 Java | 📅 2026-03-28 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,756 | 🐛 281 | 🌐 TypeScript | 📅 2026-03-23 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,959 | 🐛 298 | 🌐 TypeScript | 📅 2026-03-27 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,131 | 🐛 614 | 🌐 TypeScript | 📅 2026-03-28 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,963 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,952 | 🐛 336 | 🌐 JavaScript | 📅 2026-02-13 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,917 | 🐛 35 | 🌐 JavaScript | 📅 2026-03-25 - Automated browser testing for the modern web development stack.
* [Protractor](https://github.com/angular/protractor) ⚠️ Archived - E2E test framework for Angular apps.
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,117 | 🐛 574 | 🌐 JavaScript | 📅 2024-09-07 - Config-driven automated screenshot test framework.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,221 | 🐛 208 | 🌐 JavaScript | 📅 2026-03-26 - Modern Era Acceptance Testing Framework for NodeJS.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,910 | 🐛 37 | 🌐 JavaScript | 📅 2026-03-26 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,909 | 🐛 32 | 🌐 Java | 📅 2026-03-27 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
* [Loki](https://github.com/oblador/loki) ⭐ 1,897 | 🐛 140 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
* [Lost Pixel](https://github.com/lost-pixel/lost-pixel) ⭐ 1,652 | 🐛 66 | 🌐 TypeScript | 📅 2026-03-27 - Holistic visual regression testing for full pages, components (via Storybook and Ladle integration), and custom shots (e.g. via Cypress).
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,188 | 🐛 199 | 🌐 Java | 📅 2026-03-28.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,255 | 🐛 64 | 🌐 TypeScript | 📅 2026-03-27 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,959 | 🐛 298 | 🌐 TypeScript | 📅 2026-03-27.
...
* [Creevey](https://github.com/wKich/creevey) ⭐ 424 | 🐛 42 | 🌐 TypeScript | 📅 2026-02-12 - Cross-browser visual testing with magic. Feature-rich tool with UI Runner, Tests Hot Reloading, Docker and Storybook integration.
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 400 | 🐛 41 | 🌐 JavaScript | 📅 2026-03-27 - Visual regression test tool which output easy-to-read single file html report.
...
* [Happo](https://github.com/happo/happo.io) ⭐ 205 | 🐛 25 | 🌐 JavaScript | 📅 2026-03-20 - Visual diffing in CI for user interfaces.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,959 | 🐛 298 | 🌐 TypeScript | 📅 2026-03-27.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,188 | 🐛 199 | 🌐 Java | 📅 2026-03-28.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 679 | 🐛 58 | 🌐 Shell | 📅 2026-01-09 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 44 | 🌐 JavaScript | 📅 2026-03-27 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,188 | 🐛 199 | 🌐 Java | 📅 2026-03-28.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,188 | 🐛 199 | 🌐 Java | 📅 2026-03-28 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,756 | 🐛 281 | 🌐 TypeScript | 📅 2026-03-23 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,188 | 🐛 199 | 🌐 Java | 📅 2026-03-28.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,377 | 🐛 11 | 📅 2026-03-01.
