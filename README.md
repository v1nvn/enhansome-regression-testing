# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 447,390 | 🐛 88 | 📅 2026-03-09 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,225 | 🐛 0 | 📅 2026-03-20.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,150 | 🐛 192 | 🌐 Java | 📅 2026-03-21 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,749 | 🐛 278 | 🌐 TypeScript | 📅 2026-03-20 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,886 | 🐛 294 | 🌐 TypeScript | 📅 2026-03-20 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 84,650 | 🐛 621 | 🌐 TypeScript | 📅 2026-03-21 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,917 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-12 - Automated browser testing for the modern web development stack.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,150 | 🐛 192 | 🌐 Java | 📅 2026-03-21.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,886 | 🐛 294 | 🌐 TypeScript | 📅 2026-03-20.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 399 | 🐛 40 | 🌐 JavaScript | 📅 2026-03-19 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,886 | 🐛 294 | 🌐 TypeScript | 📅 2026-03-20.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,150 | 🐛 192 | 🌐 Java | 📅 2026-03-21.
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 33 | 🌐 JavaScript | 📅 2026-03-19 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,150 | 🐛 192 | 🌐 Java | 📅 2026-03-21.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,150 | 🐛 192 | 🌐 Java | 📅 2026-03-21 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,749 | 🐛 278 | 🌐 TypeScript | 📅 2026-03-20 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,150 | 🐛 192 | 🌐 Java | 📅 2026-03-21.
