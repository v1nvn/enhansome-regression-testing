# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 460,013 | 🐛 67 | 📅 2026-04-19 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,256 | 🐛 2 | 📅 2026-04-22.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,072 | 🐛 194 | 🌐 Java | 📅 2026-04-29 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,804 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-27 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,219 | 🐛 303 | 🌐 TypeScript | 📅 2026-04-28 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 87,580 | 🐛 498 | 🌐 TypeScript | 📅 2026-04-29 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,808 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,946 | 🐛 336 | 🌐 JavaScript | 📅 2026-04-05 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,914 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-15 - Automated browser testing for the modern web development stack.
* [Protractor](https://github.com/angular/protractor) ⚠️ Archived - E2E test framework for Angular apps.
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,134 | 🐛 574 | 🌐 JavaScript | 📅 2024-09-07 - Config-driven automated screenshot test framework.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,221 | 🐛 208 | 🌐 JavaScript | 📅 2026-04-29 - Modern Era Acceptance Testing Framework for NodeJS.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,909 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-23 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,910 | 🐛 28 | 🌐 Java | 📅 2026-04-28 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
* [Loki](https://github.com/oblador/loki) ⭐ 1,902 | 🐛 140 | 🌐 JavaScript | 📅 2024-10-12 - Visual regression testing for Storybook using Chrome in docker et al.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,418 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,072 | 🐛 194 | 🌐 Java | 📅 2026-04-29.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,263 | 🐛 68 | 🌐 TypeScript | 📅 2026-04-23 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
* [Chimp](https://github.com/xolvio/chimp) ⭐ 803 | 🐛 9 | 🌐 TypeScript | 📅 2023-11-10 - Develop acceptance tests & end-to-end tests with realtime feedback.
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 637 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,219 | 🐛 303 | 🌐 TypeScript | 📅 2026-04-28.
...
* [Touca](https://github.com/trytouca/trytouca) ⭐ 510 | 🐛 7 | 🌐 TypeScript | 📅 2024-08-04 - Open source continuous regression testing without the hassle of managing snapshot files.
* [CSSCritic](https://github.com/cburgmer/csscritic) ⭐ 491 | 🐛 17 | 🌐 JavaScript | 📅 2023-01-28 - Lightweight CSS regression testing.
...
* [Creevey](https://github.com/wKich/creevey) ⭐ 427 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-12 - Cross-browser visual testing with magic. Feature-rich tool with UI Runner, Tests Hot Reloading, Docker and Storybook integration.
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 405 | 🐛 42 | 🌐 JavaScript | 📅 2026-04-29 - Visual regression test tool which output easy-to-read single file html report.
* [Hardy](https://github.com/thingsinjars/Hardy) ⭐ 325 | 🐛 10 | 🌐 JavaScript | 📅 2015-03-27 - Selenium-driven, cucumber-powered CSS testing.
* [grunt-photobox](https://github.com/stefanjudis/grunt-photobox) ⭐ 279 | 🐛 3 | 🌐 Smarty | 📅 2016-06-13 - Plugin to prevent your project of broken layout via screenshot photo sessions of your site.
* [AyeSpy](https://github.com/newsuk/ayespy) ⭐ 220 | 🐛 43 | 🌐 JavaScript | 📅 2025-10-06 - 44 image comparisons in 90 seconds.
* [Happo](https://github.com/happo/happo.io) ⭐ 206 | 🐛 25 | 🌐 JavaScript | 📅 2026-04-14 - Visual diffing in CI for user interfaces.
* [OSnap](https://github.com/eWert-Online/osnap) ⭐ 171 | 🐛 5 | 🌐 OCaml | 📅 2025-08-30 - The speedy and easy to use Snapshot Testing tool for your project (1200 snapshots will run in under 3 minutes).
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,219 | 🐛 303 | 🌐 TypeScript | 📅 2026-04-28.
...
* [Shoov](https://github.com/shoov/shoov) ⭐ 41 | 🐛 56 | 🌐 PHP | 📅 2018-12-07 - UI regression and functional testing focused on Drupal 7 sites.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,072 | 🐛 194 | 🌐 Java | 📅 2026-04-29.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 684 | 🐛 59 | 🌐 Shell | 📅 2026-04-02 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 48 | 🌐 JavaScript | 📅 2026-04-26 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Make visual regression testing easier](https://medium.com/@nima.soroush.h/make-visual-regression-testing-easier-4a3dc7073737) - Introduction to [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 637 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 and how to use it.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,072 | 🐛 194 | 🌐 Java | 📅 2026-04-29.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,072 | 🐛 194 | 🌐 Java | 📅 2026-04-29 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
* [dpxdt](https://github.com/bslatkin/dpxdt) ⭐ 1,440 | 🐛 29 | 🌐 Python | 📅 2016-12-05 - End-to-end testing with Python.
...
* [trifleJS](https://github.com/sdesalas/trifleJS) ⭐ 823 | 🐛 19 | 🌐 JavaScript | 📅 2026-04-27 - Headless automation for Internet Explorer. (last update 2016)
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,804 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-27 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,072 | 🐛 194 | 🌐 Java | 📅 2026-04-29.
...
License holders are [all contributors](https://github.com/mojoaxel/awesome-regression-testing/graphs/contributors) ⭐ 2,378 | 🐛 13 | 📅 2026-03-01.
