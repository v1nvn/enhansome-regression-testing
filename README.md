# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,323 | 🐛 59 | 📅 2026-04-02 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,233 | 🐛 1 | 📅 2026-03-29.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,181 | 🐛 202 | 🌐 Java | 📅 2026-04-03 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,763 | 🐛 284 | 🌐 TypeScript | 📅 2026-04-01 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,012 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-02 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,504 | 🐛 632 | 🌐 TypeScript | 📅 2026-04-03 - Node library to automate Chromium, Firefox and WebKit with a single API.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,220 | 🐛 209 | 🌐 JavaScript | 📅 2026-04-02 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,181 | 🐛 202 | 🌐 Java | 📅 2026-04-03.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,012 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-02.
...
* [Happo](https://github.com/happo/happo.io) ⭐ 205 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-02 - Visual diffing in CI for user interfaces.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,012 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-02.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,181 | 🐛 202 | 🌐 Java | 📅 2026-04-03.
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 46 | 🌐 JavaScript | 📅 2026-04-02 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,181 | 🐛 202 | 🌐 Java | 📅 2026-04-03.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,181 | 🐛 202 | 🌐 Java | 📅 2026-04-03 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,763 | 🐛 284 | 🌐 TypeScript | 📅 2026-04-01 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,181 | 🐛 202 | 🌐 Java | 📅 2026-04-03.
