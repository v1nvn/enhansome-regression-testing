# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,662 | 🐛 60 | 📅 2026-04-02 with stars
...
This is intended to be an *incomplete* list of resources about visual regression testing. It is not tailored to a specific area or role (Developer/QA/UX-Designer). Note that this is for all areas of regression software testing *after* the code in question is written. For a awesome list on general software testing see e.g. [awesome-testing](https://github.com/TheJambo/awesome-testing) ⭐ 2,233 | 🐛 2 | 📅 2026-03-29.
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,187 | 🐛 200 | 🌐 Java | 📅 2026-04-07 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,764 | 🐛 283 | 🌐 TypeScript | 📅 2026-04-06 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,029 | 🐛 305 | 🌐 TypeScript | 📅 2026-04-05 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,718 | 🐛 618 | 🌐 TypeScript | 📅 2026-04-07 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,937 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
...
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,917 | 🐛 36 | 🌐 JavaScript | 📅 2026-04-02 - Automated browser testing for the modern web development stack.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,219 | 🐛 211 | 🌐 JavaScript | 📅 2026-04-06 - Modern Era Acceptance Testing Framework for NodeJS.
...
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,907 | 🐛 32 | 🌐 Java | 📅 2026-04-06 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 173 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,187 | 🐛 200 | 🌐 Java | 📅 2026-04-07.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,258 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-01 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,029 | 🐛 305 | 🌐 TypeScript | 📅 2026-04-05.
...
* [Happo](https://github.com/happo/happo.io) ⭐ 205 | 🐛 24 | 🌐 JavaScript | 📅 2026-04-06 - Visual diffing in CI for user interfaces.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,029 | 🐛 305 | 🌐 TypeScript | 📅 2026-04-05.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,187 | 🐛 200 | 🌐 Java | 📅 2026-04-07.

* [Visual Regression Tracker](https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker) ⭐ 680 | 🐛 59 | 🌐 Shell | 📅 2026-04-02 - Open Source selfhosted service for visual regression testing
...
* [Testomat.io Reporter](https://github.com/testomatio/reporter) ⭐ 145 | 🐛 43 | 🌐 JavaScript | 📅 2026-04-06 - Allows to collect tests to a Test Case Management System (TCMS) like testomat.io and sync manual and automated tests in one place.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,187 | 🐛 200 | 🌐 Java | 📅 2026-04-07.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,187 | 🐛 200 | 🌐 Java | 📅 2026-04-07 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,764 | 🐛 283 | 🌐 TypeScript | 📅 2026-04-06 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,187 | 🐛 200 | 🌐 Java | 📅 2026-04-07.
