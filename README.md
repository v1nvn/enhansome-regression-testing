# Awesome Visual Regression Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,947 | 🐛 66 | 📅 2026-04-01 with stars
...
* [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,179 | 🐛 203 | 🌐 Java | 📅 2026-04-02 - Browser automation framework and ecosystem.
* [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,762 | 🐛 283 | 🌐 TypeScript | 📅 2026-04-01 - Node.js bindings implementation for the W3C WebDriver protocol.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,000 | 🐛 297 | 🌐 TypeScript | 📅 2026-04-01 - Headless Google Chrome Node API.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 85,431 | 🐛 638 | 🌐 TypeScript | 📅 2026-04-02 - Node library to automate Chromium, Firefox and WebKit with a single API.
* [Nightmare](https://github.com/segmentio/nightmare) ⭐ 19,939 | 🐛 203 | 🌐 JavaScript | 📅 2024-04-20 - High-level browser automation library based on Electron.
* [Nightwatch](https://github.com/nightwatchjs/nightwatch) ⭐ 11,948 | 🐛 338 | 🌐 JavaScript | 📅 2026-04-01 - Automated testing and continuous integration framework based on Node.js and using the Webdriver protocol.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,917 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-02 - Automated browser testing for the modern web development stack.
...
* [CodeceptJS](https://github.com/codeception/codeceptjs/) ⭐ 4,220 | 🐛 210 | 🌐 JavaScript | 📅 2026-04-01 - Modern Era Acceptance Testing Framework for NodeJS.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,908 | 🐛 37 | 🌐 JavaScript | 📅 2026-03-26 - Jest matcher that performs image comparisons using [pixelmatch](https://www.npmjs.com/package/pixelmatch)
* [Selenide](https://github.com/selenide/selenide) ⭐ 1,909 | 🐛 32 | 🌐 Java | 📅 2026-04-01 - Framework powered by Selenium WebDriver for writing easy-to-read and easy-to-maintain automated tests in Java.
...
* [Galen](https://github.com/galenframework/galen) ⭐ 1,415 | 🐛 171 | 🌐 Java | 📅 2022-07-15 - Java framework based on [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,179 | 🐛 203 | 🌐 Java | 📅 2026-04-02.
* [reg-suit](https://github.com/reg-viz/reg-suit) ⭐ 1,256 | 🐛 67 | 🌐 TypeScript | 📅 2026-04-01 - Visual regression testing suite which compares images, stores snapshots, and notifies the difference to your GitHub repo.
...
* [Differencify](https://github.com/NimaSoroush/differencify) ⭐ 636 | 🐛 27 | 🌐 JavaScript | 📅 2020-06-02 - A library for visual regression testing using [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,000 | 🐛 297 | 🌐 TypeScript | 📅 2026-04-01.
...
* [reg-cli](https://github.com/bokuweb/reg-cli) ⭐ 400 | 🐛 41 | 🌐 JavaScript | 📅 2026-04-01 - Visual regression test tool which output easy-to-read single file html report.
...
* [Muppeteer](https://github.com/HuddleEng/Muppeteer) ⚠️ Archived - Visual regression testing framework for Chrome using [Mocha](https://mochajs.org/) and [Puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 94,000 | 🐛 297 | 🌐 TypeScript | 📅 2026-04-01.
...
* [BrowserStack](https://www.browserstack.com) - Free for Open Source. Supports [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,179 | 🐛 203 | 🌐 Java | 📅 2026-04-02.
...
* [Huxley](https://github.com/facebookarchive/huxley) ⚠️ Archived - Python framework based on [Selenium Webdriver](https://github.com/SeleniumHQ/selenium/tree/master/javascript/node/selenium-webdriver) ⭐ 34,179 | 🐛 203 | 🌐 Java | 📅 2026-04-02.
* [Gemini](https://github.com/gemini-testing/gemini) ⚠️ Archived - Feature rich framework with support for [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,179 | 🐛 203 | 🌐 Java | 📅 2026-04-02 and  [CasperJS](https://github.com/casperjs/casperjs) ⚠️ Archived. Gemini is deprecated, use hermione instead.
...
* [WebdriverCSS](https://github.com/webdriverio/webdrivercss) ⚠️ Archived - WebdriverCSS sits on top of [Webdriver.io](https://github.com/webdriverio/webdriverio/) ⭐ 9,762 | 🐛 283 | 🌐 TypeScript | 📅 2026-04-01 and hooks into [Selenium](https://github.com/SeleniumHQ/selenium) ⭐ 34,179 | 🐛 203 | 🌐 Java | 📅 2026-04-02.
